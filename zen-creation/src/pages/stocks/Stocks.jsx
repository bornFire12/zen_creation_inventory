...
export default function Stocks() {
  ...
  const [openProductRemoveStatusModal, setOpenProductRemoveStatusModal] = useState(false);
  ...
  const [stockTable, setStockTable] = useState([
    { id: "001 (auto)", name: "Cap", variety: 2, items: [] },
    { id: "002 (auto)", name: "Shoes", variety: 1, items: [] },
  ]);
  
  const handleAddProduct = ({ name, variety }) => {
  ...
  const activities = [
    { text: "350 Red Caps Added in Stock", addedBy: "Rashik Tuladhar", time: "10 Mins Ago" },
    { text: "121 Shoes Added in Stock", addedBy: "Rashik Tuladhar", time: "20 Mins Ago" },
    { text: "50 Red Belts Added in Stock", addedBy: "Rashik Tuladhar", time: "30 Mins Ago" },
    { text: "21 Red Jackets Added in Stock", addedBy: "Rashik Ratna Tuladhar", time: "40 Mins Ago" },
    { text: "15 Belt Added in Stock", addedBy: "Subin Ratna Tuladhar", time: "50 Mins Ago" },
  ];
  ...
  return (
    <Layout>
      ...
      <div className="bg-[#E1E1DC] dark:bg-[#43433F] p-6 rounded-xl">
        ...
        {/* Add Product */}
        <div className="mt-4">
          <button className="cursor-pointer flex items-center gap-2 bg-green-700 text-white px-4 py-2 rounded-lg"
          onClick={() => setOpen(true)}>
            <Plus size={18} />
            Add Product
          </button>
          <AddProductModal open={open} onClose={() => setOpen(false)} onAdd={handleAddProduct}
                ...
                >
                  ...
                  <td className="p-2 border border-[#BDBDB8]">
                    <div className="flex justify-center gap-3">
                      <Plus size={24} className="text-green-600 cursor-pointer" onClick={() => handleOpenAddInventory(row)} />
                      <Eye size={24} className="text-blue-600 cursor-pointer" />
                      <Trash2 size={24} className="text-red-600 cursor-pointer" onClick={() => handleRemoveProduct(row.id)} />
                    </div>
                  </td>
                </tr>
              ))}
          ...
          <div className="bg-[#FBFBF5] rounded-xl shadow-md">
            ...
            <ul className="space-y-3 text-sm">
              {activities.map((item, i) => (
                <li key={i} className="flex justify-between items-center pb-2 pr-4 pl-4 pt-2 border-b dark:bg-[#FBFBF5] dark:text-[#22231F] m-1">
                  <div>
